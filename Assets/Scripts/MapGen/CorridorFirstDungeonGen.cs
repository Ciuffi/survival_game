...
public class CorridorFirstDungeonGen : SimpleWalkGenerator
{
    [SerializeField]
    private int corridorLength = 10, corridorCount = 4;
    [SerializeField]
    [Range(0.1f,1)]
    ...
    private void CreateCorridors(HashSet<Vector2Int> floorPositions, HashSet<Vector2Int> potentialRoomPositions)
    {
        ...
        {
            var corridor = ProcGenAlgo.RandomWalkCorridor(currentPosition, corridorLength);
