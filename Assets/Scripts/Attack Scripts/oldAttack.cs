...
public class oldAttack : MonoBehaviour, Upgrade
{
    public float damage;
    ...
    {
        get => attackType == RangedAttackFunctions.Shotgun ? 0 : spread * shotsPerAttack;
    }
    ...
    public RangedAttackFunctions attackType;
    ...
    public void Shoot()
    {
        switch (attackType)
        {
            case RangedAttackFunctions.SingleShot:
                StartCoroutine(ShootSingleShot());
                break;
            case RangedAttackFunctions.Shotgun:
                StartCoroutine(ShootShotgun());
                break;
            case RangedAttackFunctions.Laser:
                StartCoroutine(ShootSingleShot());
                break;
            case RangedAttackFunctions.Melee:
